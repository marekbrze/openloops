...
| żaba | `Frog` | Odkładane przez użytkownika zadanie albo wątek (inspiracja „Eat This Frog"): zielony glyph żaby. Oznaczenie to **skok na górę** — akcja-żaba dokładana do Teraz ląduje na szczycie kolejki, wątek-żaba na szczycie listy; drag & drop dalej wygrywa. Auto-zdjęcie po zjedzeniu (done / domknięcie / porzucenie); cofnięcie nie przywraca. Wiele żab naraz. | „priorytet", „flaga", „przypięte" (żaba to jednorazowy skok, nie przypięcie) |
