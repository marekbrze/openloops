...
**Scale**: stały rem, kroki: 0.75 / 0.8125 / 0.875 (baza UI) / 1 / 1.125 / 1.3125 / 1.5 rem. Stosunek kroków 1.08–1.17 (widełki product 1.125–1.2 na krokach używanych; dół kompresuje się dla mikro-etykiet).
